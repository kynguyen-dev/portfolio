    ...
    <header className='fixed top-0 left-0 right-0 z-50'>
      ...
      >
        <div className='flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto'>
          ...
          {/* Desktop Nav — Only show items on Home */}
          ...
          {/* Mobile Menu Toggle — Only show if there are items to navigate */}
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div className='p-6 flex justify-center gap-4 border-t border-ct-outline-variant/10'>
            <LanguageSwitcher />
            <AuthButton />
          </div>
        </animated.div>
