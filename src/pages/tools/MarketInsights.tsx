      ...
      <Box sx={{ width: '100%', maxWidth: 1200, mt: 4 }}>
                          ...
                          <Grid container spacing={1}>
                            {[
                              ...
                              },
                              {
                                icon: SpeedIcon,
                                label: 'Áp suất',
                                value: `${weatherData.surface_pressure} hPa`,
                              },
                              {
                                icon: AirIcon,
                                label: 'Tốc độ gió',
                        ...
                        <Stack spacing={2} color='white'>
                                ...
                                <Chip
                                  ...
                                  sx={{
                                    ...
                                    bgcolor: getUVStatus(
                                      ...
                                      : 'transparent',
                                    border: '2px solid white',
                                    boxShadow: getUVStatus(
                                      weatherForecast[selectedDayIdx].uv
                                    ).danger
                                      ? `0 0 15px ${getUVStatus(weatherForecast[selectedDayIdx].uv).glow}`
                                      : 'none',
                                  }}
                                  variant='outlined'
                                />
                            ...
                            {[
                              {
                                ...
                                highlight:
                                  weatherForecast[selectedDayIdx].rainProb > 70
                                    ? {
                                        color: '#0288d1',
                                        glow: '#0288d1',
                              ...
                              },
                              {
                                ...
                                highlight: getRainStatus(
                                  weatherForecast[selectedDayIdx].rainSum
                                ),
                              },
                              {
                                icon: AirIcon,
                                ...
                                <motion.div
                                  animate={
                                    item.highlight?.danger
                                      ? {
                                          scale: [1, 1.05, 1],
                                          boxShadow: `0 0 15px ${item.highlight.glow}`,
                                        }
                                      : {}
                                  }
                                  transition={{ repeat: Infinity, duration: 2 }}
                          ...
                          >
                            <Box textAlign='center'>
                              ...
                              <PFTypography variant='body1' fontWeight={700}>
                    ...
                    !loading.weather && (
                      <Box py={6} textAlign='center'>
                        <PFTypography variant='body2' sx={{ opacity: 0.5 }}>
                          Hãy chọn một thành phố để xem thời tiết.
                        </PFTypography>
                      </Box>
                    )
                  )}
                  ...
                  <Stack spacing={2}>
                    {goldData.map(item => (
                      <Stack
                        ...
                        alignItems='center'
                      >
                        <PFTypography variant='body2' fontWeight={700}>
                          {item.type}
                        </PFTypography>
                    ...
                    {petrolData.map(item => (
                      ...
                      >
                        ...
                        <Stack
                          ...
                          alignItems='baseline'
                        >
                          <PFTypography variant='h6' fontWeight={800}>
                            {item.price}
                          </PFTypography>
        ...
        >
          <PFTypography variant='caption' sx={{ opacity: 0.6 }}>
            Dữ liệu được cập nhật từ các nguồn: Open-Meteo, NBP, CoinGecko và
            NewsAPI.
          </PFTypography>
        </Box>
      </Box>
