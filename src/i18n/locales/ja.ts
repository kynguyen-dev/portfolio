export const ja = {
  ...
  contact: {
    ...
    phoneLabel: '電話番号（任意）',
    phonePlaceholder: '(+81) 000 000 0000',
    companyLabel: '会社名（任意）',
    companyPlaceholder: 'アクメ株式会社',
    messageLabel: 'メッセージ',
    ...
    sendMeEmail: 'メールを送る',
    callMe: '電話する',
    getResume: '履歴書をダウンロード',
    phoneCopied: '電話番号をコピーしました！',
    weAreHere: 'ホーチミン市',
    ctaTitle: '新しい',
    ctaTitleAccent: 'プロジェクトですか？',
    ctaDescription:
      '現在、一部のハイエンドな戦略的パートナーシップとアーキテクチャコンサルティング業務を受け付けています。',
    ctaButton: 'コンタクト開始',
    nameRequired: 'お名前は必須です。',
    emailRequired: 'メールアドレスは必須です。',
    emailInvalid: '有効なメールアドレスを入力してください。',
    messageRequired: 'メッセージ内容は必須です。',
  },
  footer: {
