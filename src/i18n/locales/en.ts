  ...
  tools: {
    ...
    items: {
      ...
      aiSqlHelper: {
        ...
        description: 'Convert natural language into SQL queries or generate structured app plans with AI.',
      },
      marketInsights: {
        title: 'Market & Global Insights',
        description: 'Track gold, petrol, weather and international news in one dashboard.',
